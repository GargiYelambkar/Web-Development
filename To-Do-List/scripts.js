            ...
            if (filter == todo.status || filter == "all") {
                liTag += `<li class="task">
                            <label for="${id}">
                                ...
                                <p class="${completed}">${todo.name} ${todo.date ? `<span>(${todo.date})</span>` : ""} ${todo.priority ? `[${todo.priority}]` : ""}</p>
                            </label>
                            <div class="settings">
                                <i onclick="showMenu(this)" class="uil uil-ellipsis-h"></i>
                                <ul class="task-menu">
                                    <li onclick='editTask(${id}, "${todo.name}", "${todo.date}", "${todo.priority}")'><i class="uil uil-pen"></i>Edit</li>
...
function editTask(taskId, textName, date, priority) {
    editId = taskId;
    isEditTask = true;
